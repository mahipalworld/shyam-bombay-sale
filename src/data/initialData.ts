import { Product, Category, UserProfile, Address, Coupon, Order } from '@/types';
...
export const INITIAL_COUPONS: Coupon[] = [
  {
    ...
    description: 'Get ₹100 instant discount on orders above ₹999.',
  },
  {
    id: 'coup_save10',
    code: 'SAVE10',
    ...
    minOrderValue: 1499,
    expiresAt: '2026-12-31',
    description: 'Save 10% up to ₹300 on orders above ₹1499.',
  },
  {
    id: 'coup_welcome',
    code: 'FIRSTORDER',

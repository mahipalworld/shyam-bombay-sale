        ...
        <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              autoFocus
              placeholder="Search products, barcodes, orders, customers..."
              value={query}
              onChange={(e) => setQuery(e.target.value)}
              className="w-full bg-gray-100/90 focus:bg-white border border-transparent focus:border-[#F95721] text-xs font-semibold rounded-2xl pl-9 pr-16 py-2.5 outline-none transition-all placeholder:text-gray-400"
            />
            <div className="absolute right-2.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
              ...
              <button
                ...
                className="p-1 text-gray-500 hover:text-gray-900 bg-white rounded-lg shadow-2xs border border-gray-200/60"
                title="Scan Barcode"
              >
                    ...
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-gray-500 flex items-center gap-1.5 flex-wrap">
                          <span>₹{p.price} • {p.stockCount} in stock</span>
                          {p.barcode && (
                            <span className="font-mono text-[9px] bg-gray-100 text-gray-600 px-1 rounded">
                              {p.barcode}
                            </span>
                          )}
                        </p>
